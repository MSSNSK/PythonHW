...
with open('task_4_file_encode.txt', 'w') as data:
    data.write('WWWWWWWWWWWWBWWWWWWWWWWWWBBBWWWWWWWWWWWWWWWWWWWWWWWWBWWWWWWWWWWWWWW')

with open('task_4_file_encode.txt', 'r') as data:
...
with open('task_4_file_encode.txt', 'r') as file:
    decoded_string = file.read()

with open('task_4_file_decode.txt', 'w') as file:
